...
export function RegisterForm() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-1 flex-col gap-6 px-5 py-8">
      <div>
        <h1 className="text-lg font-extrabold text-neutral-900">تسجيل بيانات المنشأة</h1>
        <p className="text-sm text-neutral-400">
          مطلوبة لتوثيق المنشأة أمام هيئة البيئة وشركات التجميع
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-neutral-200 bg-white p-4">
        ...
        <p className="mb-3 text-xs text-neutral-400">
          أرفق نسخة الرقم الضريبي والسجل التجاري وأي تصاريح داعمة
        </p>
